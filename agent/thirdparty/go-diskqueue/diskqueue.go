...
func (d *diskQueue) readOne() ([]byte, error) {
	...
	if d.readFile == nil {
		...
		d.readFile, err = os.OpenFile(curFileName, os.O_RDONLY, fileMode)
		if err != nil {
			return nil, err
		}
...
func (d *diskQueue) writeOne(data []byte) error {
	...
	if d.writeFile == nil {
		...
		d.writeFile, err = os.OpenFile(curFileName, os.O_RDWR|os.O_CREATE, fileMode)
		if err != nil {
			return err
		}
...
func (d *diskQueue) retrieveMetaData() error {
	...
	f, err = os.OpenFile(fileName, os.O_RDONLY, fileMode)
	if err != nil {
		return err
	}
	defer f.Close()
...
func (d *diskQueue) persistMetaData() error {
	...
	// write to tmp file
	f, err = os.OpenFile(tmpFileName, os.O_RDWR|os.O_CREATE, fileMode)
	if err != nil {
		return err
	}
